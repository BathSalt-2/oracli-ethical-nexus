...
const HeroSection: React.FC = () => (
  <section className="relative isolate pt-12 pb-20 flex flex-col md:flex-row items-center justify-center bg-transparent overflow-hidden min-h-screen">
    ...
    <div className="w-full md:w-3/5 flex flex-col items-start px-6 z-10 relative">
      ...
      <h1 className="text-[clamp(2.4rem,8vw,4.5rem)] font-black leading-[1.1] text-left text-bright drop-shadow-2xl mb-6 perspective-1000">
        ...
        <span className="inline-block transform-3d hover:scale-105 transition-transform duration-300 delay-200">
          <span className="text-bright-cyan glow-cyan">Build Like It's </span>
          <span className="text-purple-200 font-black glow-purple">War.</span>
        </span>
      </h1>
      
      <p className="mt-8 max-w-xl text-lg md:text-2xl text-bright-muted font-medium [text-wrap:pretty] backdrop-blur-sm">
      ...
      <div className="mt-8 backdrop-holographic rounded-2xl p-6 shadow-2xl max-w-lg animate-float-3d border-holographic relative overflow-hidden">
        ...
        <p className="mb-4 text-bright-cyan font-semibold text-base relative z-10">
        ...
        <span className="text-bright-muted text-sm relative z-10">
      ...
      <div className="mt-10 relative group">
        ...
        <Link
          to="/dashboard"
          className="relative inline-block text-lg font-bold transition-all duration-300 bg-gradient-to-r from-cyan-500/90 to-purple-500/90 text-white px-8 py-4 rounded-xl shadow-2xl hover:shadow-cyan-500/25 focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900 backdrop-blur-sm border border-cyan-400/30 transform hover:scale-105"
        >
